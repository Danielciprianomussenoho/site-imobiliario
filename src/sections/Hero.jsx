...
const Hero = () => {
  ...
  return (
   ...
   <div className={`${darkMode ? "dark bg-black" : "light bg-white"}`}>
    <section id='hero' className='w-[95%] h-[600px] m-auto bg-cover bg-center rounded-xl flex flex-col justify-center items-start lg:px-28 px-10 gap-7 z-20' style={{backgroundImage : `url(${heroimg}`}}>
        ...
        <p data-aos = "zoom-in" className='text-xl text-white lg:pr-[500px] pr-0'>Through our proprietary paltaform, WpResidence is changing how agents and clients navigate the process of finding or selling a home.</p>
    </section>
   </div>

   {/*form starts from here */}

   <div className={`${darkMode ? "dark bg-black" : "light bg-trasparent"} z-10`}>
      <div data-aos="zoom-in" id='form' className={`${darkMode ? "dark bg-gray-800" : "light bg-white"} lg:w-[70%] w-full m-auto grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-6 p-8 rounded-xl -mt-14`}>
        <div className='w-full'>
              ...
              <input placeholder='Enter an address, state, city or pincode' className='bg-white p-2 w-full mt-2 border-b-[1px] border-[#c9c7c1]' type="text" />
        </div>
        <div className='w-full'>
